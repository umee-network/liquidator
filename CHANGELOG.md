...
* (<tag>) [#<PR-number>](https://github.com/umee-network/liquidator/pull/<PR-number>) <changelog entry>
...
## [<version>](https://github.com/umee-network/liquidator/releases/tag/<version>) - YYYY-MM-DD
